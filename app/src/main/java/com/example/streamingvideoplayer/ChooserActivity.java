...
public class ChooserActivity extends AppCompatActivity implements DownloadTracker.Listener, ExpandableListView.OnChildClickListener {
    ...
    public boolean onChildClick(ExpandableListView parent, View view, int groupPosition, int childPosition, long id) {
        ...
        startActivity(
                sample.buildIntent(this, isNonNullAndChecked(preferExtensionDecodersMenuItem), isNonNullAndChecked(randomAbrMenuItem)
                        ? PlayerActivity.ABR_ALGORITHM_RANDOM : PlayerActivity.ABR_ALGORITHM_DEFAULT));
        return true;
    }
    ...
    private void onSampleDownloadButtonClicked(Sample sample) {
        ...
        if (downloadUnsupportedStringId != 0) {
            ...
            RenderersFactory renderersFactory = ((DemoApplication) getApplication()).buildRenderersFactory(isNonNullAndChecked(preferExtensionDecodersMenuItem));
            downloadTracker.toggleDownload(getSupportFragmentManager(), sample.name, uriSample.uri, uriSample.extension, renderersFactory);
        }
    }
    ...
    private final class SampleListLoader extends AsyncTask<String, Void, List<SampleGroup>> {
        ...
        private Sample readEntry(JsonReader reader, boolean insidePlaylist) throws IOException {
            ...
            if (playlistSamples != null) {
                ...
                return new UriSample(sampleName, drmInfo, uri, extension, adTagUri, sphericalStereoMode);
            }
        }
    ...
    private final class SampleAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            View view = convertView;
            if (view == null) {
                view = getLayoutInflater().inflate(android.R.layout.simple_expandable_list_item_1, parent, false);
            }
        ...
        private void initializeChildView(View view, Sample sample) {
            ...
            downloadButton.setImageResource(isDownloaded ? R.drawable.ic_done_black_24dp : R.drawable.ic_file_download_black_24dp);
        }
    }
    ...
    private static final class UriSample extends Sample {
        ...
        public UriSample(String name, DrmInfo drmInfo, Uri uri, String extension, String adTagUri, String sphericalStereoMode) {
            super(name, drmInfo);
            this.uri = uri;
